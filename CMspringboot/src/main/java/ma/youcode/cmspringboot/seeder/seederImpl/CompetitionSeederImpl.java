...
@Override
    ...
    public List<Competition> createListCompetition() {
        ...
        competitionList.add(new Competition().builder().amount(300f).code("ims-03-03-24").location("casablanca").date(LocalDate.of(2024, 02, 20)).startDate(LocalTime.of(8, 0)).endTime(LocalTime.of(20, 0)).numberOfParticipants((int) (Math.random()*400)).build());
